...
type CancelDeferredEscalationsForIssueAgentRow struct {
	...
	SupersessionKind       pgtype.Text        `json:"supersession_kind"`
...
const cancelSupersededQueuedCommentTasksForAgent = `-- name: CancelSupersededQueuedCommentTasksForAgent :many
WITH queued AS (
    SELECT
        q.id,
        q.agent_id,
...
chosen AS (
    SELECT queued_id, supersession_kind, superseded_by_task_id, superseded_comment_ids FROM trusted_receipts
    UNION ALL
    SELECT d.queued_id, d.supersession_kind, d.superseded_by_task_id, d.superseded_comment_ids
...
func (q *Queries) CancelSupersededQueuedCommentTasksForAgent(ctx context.Context, agentID pgtype.UUID) ([]AgentTaskQueue, error) {
	rows, err := q.db.Query(ctx, cancelSupersededQueuedCommentTasksForAgent, agentID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, supersession_kind, superseded_by_task_id, superseded_comment_ids FROM agent_task_queue
WHERE id = $1
`
...
SELECT atq.id, atq.agent_id, atq.issue_id, atq.status, atq.priority, atq.dispatched_at, atq.started_at, atq.completed_at, atq.result, atq.error, atq.created_at, atq.context, atq.runtime_id, atq.session_id, atq.work_dir, atq.trigger_comment_id, atq.chat_session_id, atq.autopilot_run_id, atq.attempt, atq.max_attempts, atq.parent_task_id, atq.failure_reason, atq.trigger_summary, atq.force_fresh_session, atq.is_leader_task, atq.wait_reason, atq.initiator_user_id, atq.handoff_note, atq.prepare_lease_expires_at, atq.squad_id, atq.runtime_mcp_overlay, atq.escalation_for_task_id, atq.fire_at, atq.originator_user_id, atq.runtime_connected_apps, atq.coalesced_comment_ids, atq.delivered_comment_ids, atq.chat_input_task_id, atq.chat_finalize_deferred_at, atq.originator_source, atq.delegated_from_task_id, atq.retry_of_task_id, atq.rerun_of_task_id, atq.rule_version_id, atq.trigger_evidence_kind, atq.trigger_evidence_ref_id, atq.accountable_user_id, atq.supersession_kind, atq.superseded_by_task_id, atq.superseded_comment_ids FROM agent_task_queue atq
...
const recordTrustedTaskSupersessionReceipt = `-- name: RecordTrustedTaskSupersessionReceipt :one
WITH target AS (
    SELECT
        q.id,
        q.issue_id,
...
RETURNING t.id, t.issue_id, t.agent_id, planned_comment_ids, normalized_requested_ids, s.id, agent_task_queue.id, agent_task_queue.agent_id, agent_task_queue.issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, supersession_kind, superseded_by_task_id, superseded_comment_ids
`
...
type RecordTrustedTaskSupersessionReceiptRow struct {
	...
	IssueID                pgtype.UUID        `json:"issue_id"`
	AgentID                pgtype.UUID        `json:"agent_id"`
	PlannedCommentIds      interface{}        `json:"planned_comment_ids"`
	NormalizedRequestedIds interface{}        `json:"normalized_requested_ids"`
	ID_2                   pgtype.UUID        `json:"id_2"`
	ID_3                   pgtype.UUID        `json:"id_3"`
	AgentID_2              pgtype.UUID        `json:"agent_id_2"`
