...
type Handler struct {
	...
	// CIProfileVerifier is intentionally nil until a separately-authorized
	// adapter can attest a profile's immutable projection. Enable fails closed.
	CIProfileVerifier ciprofile.Verifier
