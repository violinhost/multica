...
export function buildWelcomeIssueText(
  ...
  const header = [
    ...
    ``,
    `[Learn how Multica works →](https://multica.velafi.ai/docs/how-multica-works)`,
    ``,
    `---`,
    ``,
  ].join("\n");
...
export function buildAgentGuidedSubIssues(
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        ``,
        `[Learn about assigning issues →](https://multica.velafi.ai/docs/assigning-issues)`,
      ].join("\n"),
    },
    {
      status: "todo",
      ...
      description: [
        ...
        ``,
        `[Learn about chat →](https://multica.velafi.ai/docs/chat)`,
      ].join("\n"),
    },
    {
      status: "todo",
      ...
      description: [
        ...
        ``,
        `[Learn about workspaces →](https://multica.velafi.ai/docs/workspaces)`,
      ].join("\n"),
    },
  ];
  ...
  if (q.team_size === "team") {
    tier2.push({
      ...
      description: [
        ...
        ``,
        `[Learn about members and roles →](https://multica.velafi.ai/docs/members-roles)`,
      ].join("\n"),
    });
  }
  ...
  tier2.push({
    ...
    description: [
      ...
      ``,
      `[Learn about creating agents →](https://multica.velafi.ai/docs/agents-create)`,
    ].join("\n"),
  });
  ...
  const tier3: ImportStarterIssuePayload[] = [
    ...
    },
    {
      ...
      description: [
        ...
        ``,
        `[Learn about tasks →](https://multica.velafi.ai/docs/tasks)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[Learn about the inbox →](https://multica.velafi.ai/docs/inbox)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[Learn about autopilots →](https://multica.velafi.ai/docs/autopilots)`,
      ].join("\n"),
    },
  ];
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        ``,
        `[Learn about runtimes →](https://multica.velafi.ai/docs/daemon-runtimes)`,
      ].join("\n"),
    },
    {
      status: "todo",
