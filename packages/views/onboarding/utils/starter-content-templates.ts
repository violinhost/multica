  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        `1. Ask the workspace owner for the Velafi Multica desktop \`.dmg\` (or download from the upstream GitHub release if approved)`,
        `2. Install and open the app — point it at \`https://multica.velafi.ai\` when prompted`,
