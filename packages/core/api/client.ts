...
export class ApiClient {
  ...
  // App Config
  // Velafi fork: the OIDC config fields (oidc_*) are added to AppConfigSchema
  // in schemas.ts so they survive parseWithFallback. The frontend reads these
  // to build the OIDC authorize / end-session URLs for Lark/Authentik SSO.
