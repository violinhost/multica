...
export interface AppConfigResponse {
  ...
  // Velafi fork: OIDC (Lark via Authentik) login config exposed by config.go.
...
export const AppConfigSchema = z.object({
  ...
  // Velafi fork: OIDC (Lark via Authentik) login config.
  oidc_issuer_url: OptionalStringSchema,
  oidc_client_id: OptionalStringSchema,
  oidc_authorization_endpoint: OptionalStringSchema,
  oidc_end_session_endpoint: OptionalStringSchema,
  oidc_redirect_uri: OptionalStringSchema,
  auth_callback_path: OptionalStringSchema,
